...
run = "$oneC_root/1cv8" ENTERPRISE /Lru /F"$WORKSPACE/build/ib/" /Nadmin /C"xddRun;$WORKSPACE/Tests/;xddReportFormat;xml;xddExitCodePath;$WORKSPACE/out.txt;xddReportPath;$WORKSPACE/test-reports/thick.xml;" /Execute"$WORKSPACE/xddTestRunner.epf" /RunModeOrdinary /outrunTest.txt
echo "$run"
run
"$oneC_root/1cv8c" ENTERPRISE /Lru /F"$WORKSPACE/build/ib/" /Nadmin /C"xddRun;$WORKSPACE/Tests/ManagedApp/;xddReportFormat;xml;xddExitCodePath;$WORKSPACE/out.txt;xddReportPath;$WORKSPACE/test-reports/thin_Managedapp.xml;" /Execute"$WORKSPACE/src/xddTestRunner.epf" /outrunTest.txt  /TESTMANAGER

"$oneC_root/1cv8c" ENTERPRISE /Lru /F"$WORKSPACE/build/ib/" /Nadmin /C"xddRun;$WORKSPACE/src/Tests/Gui83/;xddReportFormat;xml;xddExitCodePath;$WORKSPACE/out.txt;xddReportPath;$WORKSPACE/test-reports/thin_GUI.xml;" /Execute"$WORKSPACE/src/xddTestRunner.epf" /outrunTest.txt  /TESTMANAGER
