...
Процедура ЗаполнитьНаборТестов(НаборТестов) Экспорт
	...
	НаборТестов.Добавить("Тест_ПоследовательныйВызов", , "Открытие списка, поиск и открытие текущей строки последовательно");
	
	//НаборТестов.Добавить("Тест_ОтключениеКлиента", , "Отключение клиента тестирования");
...
&НаКлиенте
Процедура Тест_ПоследовательныйВызов() Экспорт
