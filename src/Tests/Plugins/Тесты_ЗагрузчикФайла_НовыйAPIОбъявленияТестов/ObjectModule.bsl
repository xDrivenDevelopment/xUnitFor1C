...
Процедура ЗаполнитьНаборТестов(НаборТестов) Экспорт
	...
	НаборТестов.Добавить("ТестДолжен_УстановитьЖурналВыполнения");
	НаборТестов.Добавить("ТестДолжен_ПроверитьЖурналВыполнения");
	НаборТестов.ДобавитьДеструктор("ПослеЗапускаГруппыТестов");
КонецПроцедуры

Процедура ТестДолжен_УстановитьЖурналВыполнения() Экспорт
	ЖурналВыполнения = "УстановитьЖурналВыполнения;";
КонецПроцедуры

Процедура ТестДолжен_ПроверитьЖурналВыполнения() Экспорт
	Ожидаем.Что(ЖурналВыполнения, "ТестДолжен_ПроверитьЖурналВыполнения").Равно("УстановитьЖурналВыполнения;");
...
Процедура ПослеЗапускаГруппыТестов() Экспорт
	//Сообщить("ПослеЗапускаГруппыТестов -- ЖурналВыполнения " + ЖурналВыполнения);
	Ожидаем.Что(ЖурналВыполнения, "ПослеЗапускаГруппыТестов").Равно("УстановитьЖурналВыполнения;ПроверитьЖурналВыполнения;");
	ЖурналВыполнения = ЖурналВыполнения + "ПослеЗапускаГруппыТестов;";
КонецПроцедуры
