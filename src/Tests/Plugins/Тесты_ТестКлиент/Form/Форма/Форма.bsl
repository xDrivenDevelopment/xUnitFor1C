...
Процедура Тест_ПроверкаДвижений() Экспорт
	...
	ТестКлиент
		...
		.УстановкаОтбораВСписке(Новый Структура("Ключ,Значение,ПредставлениеТипаДанных,ЗаголовокОкнаДанных", "Регистратор", СтрШаблон("Номер=%1;Дата=%2", ТестовыеДанные.Номер, ТестовыеДанные.Дата), "Документ2", "Документ2"))
...
Процедура Тест_УстаовкаОтбораВСпискеПоРегистратору() Экспорт
	...
	ТестКлиент.Что(ТестовыеДанные, "Тестовые данные").Не_().ЭтоНеопределено();
