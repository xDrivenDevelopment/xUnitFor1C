...
// Служебный флаг, указывающий встроено ли ядро в состав конфигурации
Перем ПодсистемаВстроенаВКонфигурацию Экспорт;
...
Процедура ПередЗапускомТеста() Экспорт
	Если ПодсистемаВстроенаВКонфигурацию = Истина Тогда
