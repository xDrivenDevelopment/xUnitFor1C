...
Процедура ПередЗапускомТеста() Экспорт
	Если ЗначениеЗаполнено(ПутьКФайлуПолный) Тогда
		ИдентификаторКонвертераСПрефиксомПодсистемы = ДополнитьИдентификаторПрефиксомПодсистемы("xddTestsConvertIntoRebornFormat", ИспользуемыйПрефиксПодсистемы);
		...
		Если ПеременнаяСодержитСвойство(Конвертер, "ИспользуемыйПрефиксПодсистемы") Тогда
			Конвертер.ИспользуемыйПрефиксПодсистемы = ИспользуемыйПрефиксПодсистемы;
		КонецЕсли;
	Иначе
