...
Функция ВыполнитьТестовыйМетодНаСервере(Знач ОписаниеКонтекста, Знач ЭлементДереваТестов)
	...
	КонтекстВыполнения = СоздатьОбъектПлагина(ОписаниеКонтекста.Идентификатор, ОписаниеКонтекста.ЭтоВнутренняяОбработка);
...
&НаСервере
Функция СоздатьОбъектПлагина(Идентификатор, ЭтоВнутренняяОбработка = Ложь)
	
	ОбъектНаСервере = ЭтотОбъектНаСервере();
		
	Возврат ОбъектНаСервере.СоздатьОбъектПлагина(Идентификатор, ЭтоВнутренняяОбработка);
