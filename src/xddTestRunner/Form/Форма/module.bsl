...
Процедура ОткрытьИнструмент(Знач ИмяИнструмента, Знач ПутьИнструмента = "", Знач ИмяФормы = "Форма")
	...
	Если ЭтотОбъект.ЭтоВстроеннаяОбработка Тогда
		...
		ОткрытьИнструментФрагмент(НоваяФорма);
	Иначе
		...
		ФайлИнструмента.НачатьПроверкуСуществования(Новый ОписаниеОповещения("ОткрытьИнструментЗавершение", ЭтаФорма, Новый Структура("ИмяИнструмента, ИмяФормы, ФайлИнструмента", ИмяИнструмента, ИмяФормы, ФайлИнструмента)));
	КонецЕсли;
КонецПроцедуры

Процедура ОткрытьИнструментЗавершение(Существует, ДополнительныеПараметры) Экспорт
...
Процедура ОткрытьИнструментФрагмент(НоваяФорма)
