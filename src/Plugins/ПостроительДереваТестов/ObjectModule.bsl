...
Функция СоздатьКонтейнер(ИмяКонтейнера, ИконкаУзла = Неопределено) Экспорт
	...
	//Контейнер.Вставить("ПередЗапускомГруппыТестов", "ПередЗапускомГруппыТестов");
	//Контейнер.Вставить("ПослеЗапускаГруппыТестов", "ПослеЗапускаГруппыТестов");
	Контейнер.Вставить("ИмяМетодаДеструктора", "");
