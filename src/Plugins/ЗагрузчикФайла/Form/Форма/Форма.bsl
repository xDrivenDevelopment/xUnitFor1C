...
&НаКлиенте
Перем ВырубитьКЧертямСинхронныеПроверки;
...
Процедура ПроверитьКорректностьФайла(Файл)
	...
	Если ВыключитьСинхронныеПроверки() Тогда
		Возврат;
	КонецЕсли;
...
&НаКлиенте
Функция ВыключитьСинхронныеПроверки()
	
	Если ВырубитьКЧертямСинхронныеПроверки = Неопределено Тогда
		
		ВырубитьКЧертямСинхронныеПроверки = ЗапрещеныСинхронныеВызовы();
		
	КонецЕсли;
	
	Возврат ВырубитьКЧертямСинхронныеПроверки;
