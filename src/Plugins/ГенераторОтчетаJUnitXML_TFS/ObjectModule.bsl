...
Функция ОписаниеПлагина(ВозможныеТипыПлагинов) Экспорт
	...
	Результат.Вставить("Представление", "Отчет о тестировании в формате JUnit.xml для Microsoft TFS и VSTS");
...
Функция СоздатьОтчетНаСервере(РезультатыТестирования) Экспорт
	...
	ЗаписьXML.ЗаписатьАтрибут("disabled", XMLСтрока(РезультатыТестирования.КоличествоНеРеализованныхТестов));
...
Процедура ВывестиДанныеОтчетаТестированияРекурсивно(ЗаписьXML, РезультатыТестирования, ИмяРодителя = "")
	...
	//КонецЕсли;
		ЗаписыватьТестовыйНабор = РезультатыТестирования.ИконкаУзла = ИконкиУзловДереваТестов.Обработка ИЛИ РезультатыТестирования.ИконкаУзла = ИконкиУзловДереваТестов.Отчет;
		Если ЗаписыватьТестовыйНабор Тогда
