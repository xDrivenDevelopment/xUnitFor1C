...
&НаКлиенте
Процедура УстановитьОтборВСпискеПоРегистратору(ЗаголовокСпискаРегистратора, ПредставлениеТипаРегистратора, ОписаниеСтрокиРегистратора) Экспорт

	ОписаниеОшибки= "";
	
	ТестКлиент= ТестКлиентПоУмолчанию();
	
	КнопкаНастроитьСписок = ТестируемыйЭлемент.НайтиОбъект(Тип("ТестируемаяКнопкаФормы"), "Настроить список...");
	...
	ТаблицаВыбраныеПоля.ПерейтиКСтроке(ОписаниеСтроки);
...
&НаКлиенте
Процедура УбедитьсяЧтоЭтоСписок()
...
Процедура Отладка_ОтборВСпискеПоРегистратору(Команда)
	УстановитьОтборВСпискеПоРегистратору(Отладка_ТекстЗаголовка, Отладка_ТекстЗаголовка, СформироватьСтруктуруПоиска());
КонецПроцедуры
