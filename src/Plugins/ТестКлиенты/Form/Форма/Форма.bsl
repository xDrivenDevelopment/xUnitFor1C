...
Функция УстановитьОтборВСпискеПоРегистратору(ЗаголовокСпискаРегистратора, ПредставлениеТипаРегистратора, СтруктураПоискаРегистратора) Экспорт
	...
	ОкноВыборРегистратора = НайтиОкноПриложения(ТестКлиент, ЗаголовокСпискаРегистратора);
	
	Если ОкноВыборРегистратора = Неопределено Тогда
		//TODO: закрывать все окна и возвращать Ложь
		ВызватьИсключение СтрШаблон("Не найдена форма выбора регистратора с заголовком ""%1""", ЗаголовокСпискаРегистратора);
	КонецЕсли;
	
	ФормаВыборРегистратора = НайтиФормуОкна(ОкноВыборРегистратора, ЗаголовокСпискаРегистратора);
