...
Процедура ДобавитьОбъектВМакет(Макет, ОписательОбъекта, ШапкаДанных, МассивДанных)
	...
	Если ЗначениеЗаполнено(Ссылка) Тогда
		...
		ДобавитьДополнительныеСвойства(Макет, ОписательОбъекта, ШапкаДанных, МассивДанных, Объект); // id = ?, Задача "Добавление допсвойств", 30.06.16,  KPM
...
Процедура ДобавитьДополнительныеСвойства(Макет, ОписательОбъекта, ШапкаДанных, МассивДанных, Объект) // {id = ?, Задача "Добавление допсвойств", 30.06.16,  KPM
	НомерСтрокиМакета = Макет.ВысотаТаблицы+1;
...
КонецПроцедуры // id = ?, Задача "Добавление допсвойств", 30.06.16,  KPM }
...
Процедура ДобавитьДопСвойстваВМакет(Макет, ШапкаДанных, ИмяРеквизита, СтруктураДопСвойств) // {id = ?, Задача "Добавление допсвойств", 30.06.16,  KPM
