...
Процедура ВыбратьПутьИнтерактивноРаботаСОкномЗавершение(Результат, ДополнительныеПараметры) Экспорт
	ДополнительныеПараметры.ЗагрузитьТесты(РезультатВыбора, Результат, ДополнительныеПараметры);
КонецПроцедуры

&НаКлиенте
Функция ВыбратьПутьИнтерактивно(ФормаТестов, ИмяПлагина) Экспорт
	
	РезультатВыбора = ИмяПлагина;
